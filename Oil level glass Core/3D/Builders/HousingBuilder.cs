...
public class HousingBuilder : BaseDetailBuilder
{
    ...
    private void AddSketch1()
    {
        ...
        _smallSocketCircle.Radius = Housing.CentralHoleDiameter * 0.5;
        ...
        _smallSocketDiameterVariable = Part.AddVariable("D2", Housing.CentralHoleDiameter, "Диаметр центрального отверстия");
    ...
    private void AddSketch2()
    {
        ...
        _bigSocketCircle.Radius = Housing.GlassDiameter * 0.5;
        ...
        _bigSocketDiameterVariable = Part.AddVariable("D1", Housing.GlassDiameter, "Внутренний диаметр корпуса");
    ...
    private void ExtrudeSketch2()
    {
        ...
        _cutExtrusion1.Depth[true] = Housing.GlassSocketHeight;
        _cutExtrusion1.Update();

        _socketHeightVariable = Part.AddVariable("H1", Housing.GlassSocketHeight, "Высота внутреннего отверстия корпуса");
    ...
    private void AddSketch3()
    {
        ...
        _topFace = Part.GetFaceByPoint(
            Part.GetFaces(isPlanar),
            Housing.MainDiameter * 0.5, 
            0,
            Housing.MainHeight * 0.5
        )!;
        ...
        _helpLine.X1 = 0;
        _helpLine.Y1 = 0;
        _helpLine.X2 = (Housing.MainDiameter * 0.5 + Housing.GlassDiameter * 0.5) / 2;
        _helpLine.Y2 = 0;
        _helpLine.Update();
    ...
    private void CreateHole1()
    {
        ...
        double x = (Housing.MainDiameter * 0.5 + Housing.GlassDiameter * 0.5) / 2;
        double y = 0;
    ...
    private void AddChamfer()
    {
        ...
        _chamfer1.Angle = Housing.Chamfer.Angle;
        _chamfer1.Distance1 = Housing.Chamfer.Length;
        ...
        _chamferAngleVariable = Part.AddVariable("alpha", Housing.Chamfer.Angle, "Угол фаски");
        _chamferLengthVariable = Part.AddVariable("l1", Housing.Chamfer.Length, "Длина фаски");
